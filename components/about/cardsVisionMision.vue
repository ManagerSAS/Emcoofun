<template>
    <v-container fluid >
        <v-row justify="center" align="center" class="mt-10 mb-5 pa-md-0">
			<v-col cols="12" sm="12" md="12" lg="10" xl="8">
                <v-row>
                    ...
                    <v-col cols="12" sm="10" md="10" lg="10" class="mt-5 text-raleway" style="color:#003B4C; font-size: 15px; font-weight: 600;">
                ...
                <v-row>
                    <v-col cols="12" sm="10" md="10" lg="10" class="mt-10 text-raleway" style="color:#003B4C; font-size: 15px; font-weight: 600;">
